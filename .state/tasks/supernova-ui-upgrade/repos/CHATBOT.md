...
Next repo step:
- Open a draft PR or continue with optional form-page polish. If a real document is added, revisit `/documents/{id}` and delete-modal browser QA.
