...
Next repo step:
- Begin Phase 5 admin/course/chapter management polish. If a real document is added, revisit `/documents/{id}` and delete-modal browser QA.
