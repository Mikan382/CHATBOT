...
public interface IChatService
{
    ...
    Task<ChatMessageDto> SaveUserMessageAsync(Guid sessionId, Guid userId, Guid courseId, ChatModelType modelType, string text, CancellationToken cancellationToken);
    Task<ChatMessageDto> GenerateAssistantReplyAsync(Guid sessionId, Guid userId, Guid courseId, ChatModelType modelType, string text, CancellationToken cancellationToken);
    Task<ChatResponseDto> SendAsync(Guid sessionId, Guid userId, Guid courseId, ChatModelType modelType, string text, CancellationToken cancellationToken);
